...
function [gBestScore,gBest,GlobalBestCost]=CCPSOGSA(Benchmark_Function_ID,n,iteration,chaosIndex,chValueInitial)
...
%        G=G0*exp(-23*iter/iteration); %Equation (4)
    case 1
        G=G+chaos(chaosIndex,iter,iteration,chValue);
    case 2
        G=G+chaos(chaosIndex,iter,iteration,chValue);
    case 3
        G=G+chaos(chaosIndex,iter,iteration,chValue);
